...
const player       =  document.querySelector('.player');  /*screen size*/

const video        =  player.querySelector('.viewer');  /*video which will be played*/

const progress     =  player.querySelector('.progress');
const progressBar  =  player.querySelector('.progress__filled');

const toggle       =  player.querySelector('.toggle'); /* play and pause button*/
const skipButtons  =  player.querySelectorAll('[data-skip]');
const ranges       =  player.querySelectorAll('.player__slider'); /* volume*/

const current      =  player.querySelector('.current'); /* current time*/
const duration     =  player.querySelector('.duration'); /* time duration*/
const fullscreen   =  player.querySelector('.fullscreen-btn'); /* full screen*/
